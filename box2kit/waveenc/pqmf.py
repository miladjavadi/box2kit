...
""" 
copied from rishikksh20's multiband-hifigan
https://github.com/rishikksh20/multiband-hifigan/blob/master/pqmf.py
"""

class PQMF(torch.nn.Module):
    def __init__(self, N=16, taps=62, cutoff=0.15, beta=9.0):
