...
def main(args):
    ...
    codebook = PairedCodebook(train_data, val_data, CODEBOOK_LENGTH)
...
if __name__ == "main":
    ...
    parser.add_argument("--name", help="Name of codebook.", type=str, metavar="codebook_name", default="lightning_logs")
