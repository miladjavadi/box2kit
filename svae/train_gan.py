...
from svae.model import SingleVAE, WaveSegmentDataset, PQMFVAE, GenerationCallback, TransferGAN, PairedWaveformDataset
import torchaudio
...
def main(args):
    ...
    tblogger = TensorBoardLogger(save_dir="transgan_logs", name=EXPERIMENT_NAME)
